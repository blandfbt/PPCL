...
class PromptAdjustLineNums2Command(sublime_plugin.TextCommand):
    ...
    def revert_changes(self):
        ...
        # Last command called should be "prompt_adjust_line_num2" or "adjust_line_num2"
...
class AdjustLineNums2Command(sublime_plugin.TextCommand):
	'''
...
class InsertLines2Command(sublime_plugin.TextCommand):
	'''
